...
Misetay's intelligence lives in agent and skill files that must be copied to the user's workspace `.github/` directory. This spec defines how those files get installed.
